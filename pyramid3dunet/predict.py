...
from pyramid3dunet.datasets.utils import get_test_loaders
from pyramid3dunet.unet3d.utils import get_logger, load_checkpoint
from pyramid3dunet.unet3d.config import load_config
from pyramid3dunet.unet3d.model import get_model
...
def _get_predictor(model, output_dir, config, output_seg_dir = None, threshold = 0.5):
    ...
    m = importlib.import_module('pyramid3dunet.unet3d.predictor')
