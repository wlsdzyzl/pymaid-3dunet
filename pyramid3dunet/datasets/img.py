...
from pyramid3dunet.augment import transforms
from pyramid3dunet.datasets.utils import ConfigDataset, calculate_stats, get_slice_builder
...
class IMGDataset(ConfigDataset):
    def __init__(self, raw_file_path, label_file_path, mask_file_path, phase, slice_builder_config, transformer_config, mirror_padding=(0, 32, 32), expand_dims=True):
        ...
        # print(self.raw.shape, self.label.shape, self.mask.shape)      
    ...
    def __getitem__(self, idx):
        ...
        if self.phase == 'test' or self.label is None:
            ...
            if mask_patch_transformed is not None:
                return raw_patch_transformed, label_patch_transformed, -1, mask_patch_transformed
