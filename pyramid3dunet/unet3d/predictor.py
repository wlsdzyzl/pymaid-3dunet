...
from pyramid3dunet.datasets.nii import AbstractNIIDataset
from pyramid3dunet.unet3d.model import UNet2D
from pyramid3dunet.unet3d.utils import get_logger, remove_halo
...
class StandardNIIPredictor(_AbstractPredictor):
    ...
    def _save_results(self, prediction_maps, normalization_masks, output_heads, output_file, output_seg_file, dataset):
        ...
        for prediction_map, normalization_mask, idx in zip(prediction_maps, normalization_masks,
                                                                          idxs):
            prediction_map[normalization_mask > 0] = prediction_map[[normalization_mask > 0]] / normalization_mask[[normalization_mask > 0]]
