...
from pyramid3dunet.unet3d.losses import compute_per_channel_dice
from pyramid3dunet.unet3d.utils import get_logger, expand_as_one_hot, convert_to_numpy

logger = get_logger('EvalMetric')

### compute for batch tensor ...
...
def get_evaluation_metric(config):
    ...
    def _metric_class(class_name):
        m = importlib.import_module('pyramid3dunet.unet3d.metrics')
