...
from pyramid3dunet.datasets.utils import get_train_loaders
from pyramid3dunet.unet3d.losses import get_loss_criterion
from pyramid3dunet.unet3d.metrics import get_evaluation_metric
from pyramid3dunet.unet3d.model import get_model, UNet2D
from pyramid3dunet.unet3d.utils import get_logger, get_tensorboard_formatter, create_optimizer, \
        ...
        for t in self.loaders['train']:
            ...
            if isinstance(loss, list):
                ...
                for i, l in enumerate(loss):
                    overall_loss = overall_loss +  2**i * l
                    weight += 2**i
                loss = overall_loss / weight
                output = output[-1]
    ...
    def _forward_pass(self, input, target, weight=None):
        ...
        if isinstance(output, list):
            ...
            for o in output:
                ...
                t = F.interpolate(target, size = (o.shape[-3], o.shape[-2], o.shape[-1]))
                if weight is None:
                    loss = loss + [self.loss_criterion(o, t)]
                else:
                    loss = loss + [self.loss_criterion(o, t, weight)]
        else:
            # compute the loss
            if weight is None:
